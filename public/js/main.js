...
/* harmony export */ });
/* harmony import */ var vue_extend_layout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue-extend-layout */ "./node_modules/vue-extend-layout/vue-extend-layout.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "App",
  components: {
    VueExtendLayouts: vue_extend_layout__WEBPACK_IMPORTED_MODULE_0__.default
  },
...
/***/ "./resources/js/api/helpers/onError.js":
/*!*********************************************!*\
  !*** ./resources/js/api/helpers/onError.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (err) {
  return new Promise(function (_, reject) {
    console.error(err.response ? err.response.data : err);

    if (err.response.data.errors) {
      (0,lodash_es__WEBPACK_IMPORTED_MODULE_1__.default)(err.response.data.errors, function (errors) {
        return errors.forEach(function (err) {
          return window.$vm.$toast.error(window.$vm.$t(err));
        });
      });
    } else {
    ...
    if (_store__WEBPACK_IMPORTED_MODULE_0__.default.state.auth.user && err.response.status === 401) {
...
/***/ "./resources/js/api/helpers/requestInterceptor.js":
/*!********************************************************!*\
  !*** ./resources/js/api/helpers/requestInterceptor.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (config) {
  // Add authorization
  var token = _store__WEBPACK_IMPORTED_MODULE_0__.default.getters["auth/token"];

  if (token) {
    var company = _store__WEBPACK_IMPORTED_MODULE_0__.default.getters["companies/selected"];
...
/***/ "./resources/js/api/helpers/responseInterceptor.js":
/*!*********************************************************!*\
  !*** ./resources/js/api/helpers/responseInterceptor.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (res) {
...
/* harmony import */ var _helpers_requestInterceptor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/requestInterceptor */ "./resources/js/api/helpers/requestInterceptor.js");
/* harmony import */ var _helpers_responseInterceptor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/responseInterceptor */ "./resources/js/api/helpers/responseInterceptor.js");
/* harmony import */ var _helpers_onError__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers/onError */ "./resources/js/api/helpers/onError.js");
/* harmony import */ var querystringify__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! querystringify */ "./node_modules/querystringify/index.js");
/* provided dependency */ var process = __webpack_require__(/*! process/browser */ "./node_modules/process/browser.js");
...
Object.getOwnPropertyNames(instance).filter(function (prop) {
  ...
  api[func] = function () {
    return instance[func].apply(instance, arguments).then(function (res) {
      return res.data;
    });
  };
});
...
api["$get"] = function (url, params, config) {
  return api["get"](url + querystringify__WEBPACK_IMPORTED_MODULE_4__.stringify(params, "?"), config);
};

instance.interceptors.request.use(_helpers_requestInterceptor__WEBPACK_IMPORTED_MODULE_1__.default, function (error) {
  return Promise.reject(error);
});
instance.interceptors.response.use(_helpers_responseInterceptor__WEBPACK_IMPORTED_MODULE_2__.default, _helpers_onError__WEBPACK_IMPORTED_MODULE_3__.default);
...
vue__WEBPACK_IMPORTED_MODULE_4__.default.use(vue_meta__WEBPACK_IMPORTED_MODULE_2__.default, {
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__.default({
  ...
  routes: [{
    ...
    component: function component() {
      return __webpack_require__.e(/*! import() | home */ "home").then(__webpack_require__.bind(__webpack_require__, /*! @/views/Home */ "./resources/js/views/Home.vue"));
    },
    meta: {
      layout: 'guest'
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vuex__WEBPACK_IMPORTED_MODULE_3__.Store({
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mutations: {
    SAVE_INFO: function SAVE_INFO(state, _ref) {
      var user = _ref.user,
          token = _ref.token;
      state.user = user;
      state.token = token;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", _api__WEBPACK_IMPORTED_MODULE_1__.default.post('/auth/login', {
                  username: username,
                  password: password
                }).then(function (res) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _vue_extend_layout_vue_vue_type_template_id_d4bf1234___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vue-extend-layout.vue?vue&type=template&id=d4bf1234& */ "./node_modules/vue-extend-layout/vue-extend-layout.vue?vue&type=template&id=d4bf1234&");
/* harmony import */ var _vue_extend_layout_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vue-extend-layout.vue?vue&type=script&lang=js& */ "./node_modules/vue-extend-layout/vue-extend-layout.vue?vue&type=script&lang=js&");
...
var component = (0,_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _vue_extend_layout_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _vue_extend_layout_vue_vue_type_template_id_d4bf1234___WEBPACK_IMPORTED_MODULE_0__.render,
  _vue_extend_layout_vue_vue_type_template_id_d4bf1234___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "node_modules/vue-extend-layout/vue-extend-layout.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-extend-layout/vue-extend-layout.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-extend-layout/vue-extend-layout.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    currentLayout () {
      ...
      return () => __webpack_require__("./resources/js lazy recursive ^\\.\\/.*\\/.*\\.vue$")(`./${this.path}/${ln}.vue`)
    }
  }
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _vue_loader_lib_index_js_vue_loader_options_vue_extend_layout_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../vue-loader/lib/index.js??vue-loader-options!./vue-extend-layout.vue?vue&type=script&lang=js& */ "./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-extend-layout/vue-extend-layout.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_vue_loader_lib_index_js_vue_loader_options_vue_extend_layout_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./node_modules/vue-extend-layout/vue-extend-layout.vue?vue&type=template&id=d4bf1234&":
/*!*********************************************************************************************!*\
  !*** ./node_modules/vue-extend-layout/vue-extend-layout.vue?vue&type=template&id=d4bf1234& ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _vue_loader_lib_loaders_templateLoader_js_vue_loader_options_vue_loader_lib_index_js_vue_loader_options_vue_extend_layout_vue_vue_type_template_id_d4bf1234___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _vue_loader_lib_loaders_templateLoader_js_vue_loader_options_vue_loader_lib_index_js_vue_loader_options_vue_extend_layout_vue_vue_type_template_id_d4bf1234___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _vue_loader_lib_loaders_templateLoader_js_vue_loader_options_vue_loader_lib_index_js_vue_loader_options_vue_extend_layout_vue_vue_type_template_id_d4bf1234___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../vue-loader/lib/index.js??vue-loader-options!./vue-extend-layout.vue?vue&type=template&id=d4bf1234& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-extend-layout/vue-extend-layout.vue?vue&type=template&id=d4bf1234&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-extend-layout/vue-extend-layout.vue?vue&type=template&id=d4bf1234&":
/*!************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-extend-layout/vue-extend-layout.vue?vue&type=template&id=d4bf1234& ***!
  \************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "app" }, [_c("vue-extend-layouts")], 1)
}
var staticRenderFns = []
render._withStripped = true
...
/*!*******************************************************************************************!*\
  !*** ./resources/js/ lazy ^\.\/.*\/.*\.vue$ chunkName: layout-[request] namespace object ***!
  \*******************************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
var map = {
	"./components/ExampleComponent.vue": [
		...
		"layout-components-ExampleComponent-vue"
	],
	"./layouts/guest.vue": [
		"./resources/js/layouts/guest.vue",
		"layout-layouts-guest-vue"
	],
	"./views/Home.vue": [
...
/******/ 			return "" + chunkId + ".js?id=" + {"layout-components-ExampleComponent-vue":"6b39a336a282539c9aed","layout-layouts-guest-vue":"4171064c6c491660b046","home":"16a5411cd9f20aca07d0"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
